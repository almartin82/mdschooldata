...
Maryland’s 859,000 students span 24 Local School Systems – from tiny
Kent County (1,591 students) to sprawling Montgomery County (155,000).
Less than half are proficient in reading, and only 1 in 4 can do
grade-level math. The data tells a story of stark geographic divides and
post-pandemic challenges.

Part of the [njschooldata](https://github.com/almartin82/njschooldata)
family.

**[Full documentation](https://almartin82.github.io/mdschooldata/)** –
all 30 stories with interactive charts, getting-started guide, and
...
### 1. Math proficiency plummets from 40% in grade 3 to 7% by grade 8
...
[(source)](https://almartin82.github.io/mdschooldata/articles/maryland-assessment.html#math-decline)

------------------------------------------------------------------------

### 2. Kindergarten dropped 10% in 2020 and never fully recovered
...
kindergarten enrollment is still 8.5% below its 2019 peak.
...
Enrollment](https://almartin82.github.io/mdschooldata/articles/enrollment-trends_files/figure-html/story-04-covid-k-1.png)

COVID Impact on Grade-Level Enrollment

[(source)](https://almartin82.github.io/mdschooldata/articles/enrollment-trends.html#covid-kindergarten)

------------------------------------------------------------------------

### 3. Frederick County grew 16% – fastest in the state
...
Growth](https://almartin82.github.io/mdschooldata/articles/enrollment-trends_files/figure-html/story-09-frederick-growth-1.png)

Frederick County Enrollment Growth

[(source)](https://almartin82.github.io/mdschooldata/articles/enrollment-trends.html#frederick-growth)

## Data Taxonomy

| Category           | Years     | Function                                                                                                                                                                                                            | Details                                                                  |
|--------------------|-----------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------|
| **Enrollment**     | 2014-2024 | [`fetch_enr()`](https://almartin82.github.io/mdschooldata/reference/fetch_enr.md) / [`fetch_enr_multi()`](https://almartin82.github.io/mdschooldata/reference/fetch_enr_multi.md)                                   | State, district. Grade-level (K-12)                                      |
| **Assessments**    | 2022-2024 | [`fetch_assessment()`](https://almartin82.github.io/mdschooldata/reference/fetch_assessment.md) / [`get_statewide_proficiency()`](https://almartin82.github.io/mdschooldata/reference/get_statewide_proficiency.md) | State, district, school. ELA, Math, Science. Participation + proficiency |
| **Directory**      | current   | [`fetch_directory()`](https://almartin82.github.io/mdschooldata/reference/fetch_directory.md)                                                                                                                       | Charter schools                                                          |
...
> taxonomy](https://almartin82.github.io/mdschooldata/DATA-CATEGORY-TAXONOMY.md)
...
Full analysis with 30 stories across two vignettes: - [Enrollment
trends](https://almartin82.github.io/mdschooldata/articles/enrollment-trends.html)
– 15 stories - [Assessment
analysis](https://almartin82.github.io/mdschooldata/articles/maryland-assessment.html)
– 15 stories - [Function
reference](https://almartin82.github.io/mdschooldata/reference/)
...
<https://planning.maryland.gov/MSDC/Pages/s3_projection.aspx> - MSDE
Publications: <https://marylandpublicschools.org/about/Pages/DCAA/SSP/>

### Available Years

**Enrollment:** 2014-2024 – Grade-level enrollment from MD Department of
Planning for state and 24 jurisdictions.
...
**Enrollment:** - **Levels:** State, District (24 Local School
Systems) - **Grade levels:** K through 12 - **Years:** 2014-2024

**Note:** Demographic breakdowns (race/ethnicity, gender) are not
available via automated download due to MSDE PDF parsing limitations.
For demographics, use the [Maryland Report
Card](https://reportcard.msde.maryland.gov/Graphs/#/Demographics/Enrollment)
interactive site.
...
### 4. Montgomery County is Maryland’s largest district with 155,000 students
...
[(source)](https://almartin82.github.io/mdschooldata/articles/enrollment-trends.html#montgomery-county)

------------------------------------------------------------------------

### 5. Baltimore City lost nearly 5,000 students since 2016
...
Decline](https://almartin82.github.io/mdschooldata/articles/enrollment-trends_files/figure-html/story-03-baltimore-decline-1.png)

Baltimore City Enrollment Decline

[(source)](https://almartin82.github.io/mdschooldata/articles/enrollment-trends.html#baltimore-city-decline)

------------------------------------------------------------------------

### 6. Less than half of Maryland students are proficient in ELA
...
[(source)](https://almartin82.github.io/mdschooldata/articles/maryland-assessment.html#ela-proficiency)

------------------------------------------------------------------------

### 7. Math proficiency is half of ELA at just 24%
...
[(source)](https://almartin82.github.io/mdschooldata/articles/maryland-assessment.html#math-crisis)
...
Education](https://almartin82.github.io/mdschooldata/articles/enrollment-trends_files/figure-html/story-08-i95-corridor-1.png)

The I-95 Corridor Dominates Maryland Education

[(source)](https://almartin82.github.io/mdschooldata/articles/enrollment-trends.html#i95-corridor)

------------------------------------------------------------------------

### 9. ELA proficiency improved 3 points since 2022
...
[(source)](https://almartin82.github.io/mdschooldata/articles/maryland-assessment.html#ela-recovery)

------------------------------------------------------------------------

### 10. Western Maryland is shrinking: Garrett lost 12% since 2016

Allegany and Garrett counties in Appalachian Maryland have lost 7% and
12% of students respectively since 2016.
...
Decline](https://almartin82.github.io/mdschooldata/articles/enrollment-trends_files/figure-html/story-06-western-md-1.png)

Western Maryland Enrollment Decline

[(source)](https://almartin82.github.io/mdschooldata/articles/enrollment-trends.html#western-maryland)

------------------------------------------------------------------------

### 11. Grade 9 is 21% larger than grade 12

Maryland has 77,465 ninth-graders but only 63,844 twelfth-graders – a
21% drop. This pattern reflects students leaving the system before
graduation.
...
![Maryland Enrollment by Grade
Level](https://almartin82.github.io/mdschooldata/articles/enrollment-trends_files/figure-html/story-13-grade-structure-1.png)

Maryland Enrollment by Grade Level

[(source)](https://almartin82.github.io/mdschooldata/articles/enrollment-trends.html#grade-structure)

------------------------------------------------------------------------

### 12. Montgomery County peaked in 2019 and has been declining

Maryland’s largest district reached 160,587 students in 2019, then lost
nearly 6,000 students by 2024. This 3.6% decline signals broader
suburban enrollment pressure.
...
![Montgomery County: From Growth to
Decline](https://almartin82.github.io/mdschooldata/articles/enrollment-trends_files/figure-html/story-14-montgomery-trend-1.png)

Montgomery County: From Growth to Decline

[(source)](https://almartin82.github.io/mdschooldata/articles/enrollment-trends.html#montgomery-decline)

------------------------------------------------------------------------

### 13. ELA vs Math: The proficiency gap by grade
...
[(source)](https://almartin82.github.io/mdschooldata/articles/maryland-assessment.html#ela-math-gap)

------------------------------------------------------------------------

### 14. Anne Arundel grew 4% while nearby Baltimore County shrank

Anne Arundel County has quietly added 3,200 students since 2016, growing
4.1%. The Annapolis-area county benefits from military families at Fort
Meade and its proximity to both DC and Baltimore.
...
Growth](https://almartin82.github.io/mdschooldata/articles/enrollment-trends_files/figure-html/story-07-anne-arundel-1.png)

Anne Arundel County Enrollment Growth

[(source)](https://almartin82.github.io/mdschooldata/articles/enrollment-trends.html#anne-arundel)

------------------------------------------------------------------------

### 15. Maryland enrollment has been remarkably stable since 2016
...
![Maryland Statewide
Enrollment](https://almartin82.github.io/mdschooldata/articles/enrollment-trends_files/figure-html/story-02-state-trend-1.png)

Maryland Statewide Enrollment

[(source)](https://almartin82.github.io/mdschooldata/articles/enrollment-trends.html#statewide-enrollment)
