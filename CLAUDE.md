...
| Years | Grade Data | Ethnicity Data | Notes |
|-------|------------|----------------|-------|
| 2014-2025 | Yes | Yes (2019+) | Enrollment 2014+, demographics 2019+ |

**Data Source:** Maryland State Department of Education (MSDE)
...
- **Levels:** State, District (24 LSS), School (~1,400)
